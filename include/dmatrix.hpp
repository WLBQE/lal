    ...
    public:
        ...
        _self& operator+=(matrix<NumericType>& m) {
            std::transform(begin(), end(), m.begin(), begin(),
                           [](std::vector<NumericType>& a, std::vector<NumericType>& b) -> std::vector<NumericType>& {
                               std::transform(a.begin(), a.end(), b.begin(), a.begin(),  std::plus<NumericType>());
                               return a; });
            return *this;
        }
        ...
        _self& operator-=(matrix<NumericType>& m) {
            std::transform(begin(), end(), m.begin(), begin(),
                           [](std::vector<NumericType>& a, std::vector<NumericType>& b) -> std::vector<NumericType>& {
                               std::transform(a.begin(), a.end(), b.begin(), a.begin(),  std::minus<NumericType>());
                               return a; });
            return *this;
        }
        ...
        _self& operator*=(const NumericType& number) {
            std::transform(begin(), end(), begin(),
                           [number](std::vector<NumericType>& a) -> std::vector<NumericType>& {
                               std::transform(a.begin(), a.end(), a.begin(), [number](NumericType a)->NumericType{
                                   return a*number;
                               });
                               return a;
            });
